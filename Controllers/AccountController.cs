...
namespace INKO.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register( RegisterDto registerDto)
        {
            ...
            //greske ukoliko registracija bude neuspesna
        ...
        public async Task<IActionResult> Profile(ProfileDto profileDto)
        {
            ...
            //Azuriranje korisnickog profila
           ...
           if(result.Succeeded)
            ...
            {
                ViewBag.ErrorMessage = "Profile is not updated! The reason of this outcome is: " + result.Errors.First().Description;
            }
        ...
        public async Task<IActionResult> Password(PasswordDto passwordDto)
        {
            ...
            //Dobavljanje Usera koji je ulogovan
            var appUser = await userManager.GetUserAsync(User);
            if(appUser == null)
            {
                return RedirectToAction("Index", "Home");
            ...
            //azuriranje korisnickog passworda
        ...
        public async Task<IActionResult> ForgotPassword([Required, EmailAddress] string email)
        {
            ...
            if (user != null)
            {
                //generisanje password reset tokena
                var token = await userManager.GeneratePasswordResetTokenAsync(user);
                string resetUrl = Url.ActionLink("ResetPassword", "Account", new { token }) ?? "URL Error";

                // salji url mejlom
                string senderName = configuration["MailerLiteSettings:SenderName"] ?? "";
                string senderEmail = configuration["MailerLiteSettings:SenderEmail"] ?? "";
